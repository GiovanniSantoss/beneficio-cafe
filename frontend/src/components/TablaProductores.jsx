          ...
          {productores.map((p) => (
            <React.Fragment key={p.idProductor}>
              <tr>
                ...
                <td>
                  <span
                    className={p.activo ? "status-activo" : "status-inactivo"}
                  >
                ...
                <td className="actions">
                  <button className="btn-edit" onClick={() => onEditar(p)}>
                    Editar
                  </button>
                    ...
                    <div className="detalle-overlay">
                      <div className="detalle-card">
                        ...
                        <div className="detalle-grid">
                          ...
                          <div>
                            <b>Tipo Socio:</b> {p.tipoSocio}
                          </div>
                          <div>
                            <b>Activo:</b> {p.activo ? "Sí" : "No"}
                          </div>
                          <div>
                            <b>Fecha Ingreso:</b> {p.fechaIngreso}
                          </div>
                        </div>
